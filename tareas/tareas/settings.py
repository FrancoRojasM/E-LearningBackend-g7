...
SECRET_KEY = 'django-insecure-sv_dff4*cokkhe+ue86%tetoqjwtxaxcg&*ev(04mhi%-gdf3i'
...
# cuando modifico el modelo del usuario
...
SIMPLE_JWT={
    # Modificar la duracion que tendra la token de acceso ,para modificar otras propiedades de la libreria:
