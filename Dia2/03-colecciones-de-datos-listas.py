...
# cuando usamos dos puntos ":" al momento de definir la posicion de una lista entonces le estaremos indicando que queremos una sublista de esa lista siendo el primer valor la posicion inicial y el segundo valor hasta que posicion tiene que llegar (sin mostrar la ultima que se indica)
print(alumnos[1:3])
# destructuracion de una lista(extraer los elementos internos de la lista)
print(alumnos[:])
# cuando usamos posiciones negativas en una lista entonces la invierte, es decir, ahora la posicion-1 será el ultimo elemento de la lista y asi sucesivamente
...
# segunda forma usando el metodo pop, este metodo lo que hace es elimina el contenido de esa posicion pero se puede almacenar el contenido en otra variable
